...
module.exports = function(RED) {
    ...
    RED.nodes.registerType("FetchItGO request", FetchItRequestNode);
    ...
    function FetchItMQTTBrokerNode(n) {
        RED.nodes.createNode(this,n);
    ...
    RED.nodes.registerType("FetchItGO mqtt-broker",FetchItMQTTBrokerNode,{
        credentials: {
            user: {type:"text"},
    ...
    RED.nodes.registerType("FetchItGO mqtt in",MQTTInNode);
    ...
    RED.nodes.registerType("FetchItGO mqtt out",MQTTOutNode);
